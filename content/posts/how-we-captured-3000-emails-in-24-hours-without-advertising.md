Just last week, in preparation for our re-launch of [Traction](http://www.amazon.com/Traction-Startup-Achieve-Explosive-Customer/dp/1591848369/ref=tmm_hrd_swatch_0?_encoding=UTF8&sr=&qid=tag&tracbook-site-20), we launched[Traction Course](http://www.tractioncourse.com/), a free 14-day email course that shows you how to double your Facebook ad ROI, get more Twitter followers, and improve your email open rates by 30%+.
...
The first time I created an email course, we acquired more than 12,000 emails without any paid marketing or guest blogging. My partner Nat and I pulled together [Programming for Marketers](http://programmingformarketers.com/) in just a few weeks to teach marketers basic technical skills, and we quickly built a relatively large following.
...
Landing pages for [email1k](http://email1k.com/) and [traffic1m](http://traffic1m.com/)
...
But, enough about that. If you’re still struggling to come up with ideas, simply use [Buzzsumo](http://buzzsumo.com/) to find blog posts in your industry that have been shared the most over the last 6–12 months. If you find a few recurrent themes in there, that’s a good candidate topic to do a course about.
...
Once you have a domain chosen, it’s time to put up a landing page! For Programming for Marketers, we created our own custom theme, which took a long time but gave us some additional flexibility. If you know how to edit a bootstrap template, this might be a good way to go. If not, or if you don’t know what the previous sentence means, I’d suggest using [Instapage](http://instapage.com/).

We used Instapage for Traction Course and got a landing page up in just over an hour. They have a bunch of pre-built [templates](https://instapage.com/landing-page-templates) that make spinning up a site easy, which was important as we didn’t have time to make our own theme.
...
If you want to learn how we did this, sign up for [Traction Course](http://tractioncourse.com/) where we show you how :)
...
In our case, we promoted Traction Course on Product Hunt, [GrowthHackers](http://growthhackers.com/)and the /r/startups Reddit thread.
...
We got these subscribers with about a day of work. Not a bad ROI, especially when compared to how long it takes to write a standard blog post (and how much less you get out of it). Rather than write 7 of our best marketing hacks as blog posts and getting a few hundred hits each, we now have captured thousands of email addresses we can market [Traction](http://www.amazon.com/Traction-Startup-Achieve-Explosive-Customer/dp/1591848369/ref=tmm_hrd_swatch_0?_encoding=UTF8&sr=&qid=tag&tracbook-site-20) to when we re-launch.
